   ...
   <body>
        ...
        <div class="preloader d-flex align-items-center justify-content-center">
            <div class="preloader-inner position-relative">
                ...
                <div class="preloader-img pere-text">
                    <img src="assets/img/logo/log.svg" alt="">
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-3 col-md-2">
                            <!-- Logo -->
                            <div class="logo">
                                <a href="index.html"><img src="assets/img/logo/log.svg" alt=""></a>
                            </div>  
                        </div>
                                ...
                                <div class="main-menu">
                                    <nav class="d-none d-lg-block">
                                        <ul id="navigation">
                                            ...
                                            <li><a href="job_listing.html">Find Place </a></li>
    ...
    <main>
        ...
        <div class="slider-area ">
            <div class="single-slider section-overly slider-height2 d-flex align-items-center" data-background="assets/img/hero/park.gif">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-12">
                        ...
                        <section class="featured-job-area">
                            <div class="container">
                                ...
                                <div class="single-job-items mb-30">
                                    <div class="job-items">
                                        <div class="company-img">
                                            <a href="#"><img src="assets/img/icon/pa1.png" width="250" 
                                                height="200" alt=""></a>
                                        </div>
                                ...
                                <div class="single-job-items mb-30">
                                    <div class="job-items">
                                        <div class="company-img">
                                            <a href="#"><img src="assets/img/icon/download.jpg" width="250" 
                                                height="200" alt=""></a>
                                        </div>
                                        <div class="job-tittle job-tittle2">
                                            <a href="#">
                                    ...
                                    <div class="job-items">
                                        ...
                                        <div class="job-tittle job-tittle2">
                                            ...
                                            <ul>
                                                ...
                                                <li><i class="fas fa-map-marker-alt"></i>Tanger</li>
                                                <li>3500DH - 4000DH</li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div class="single-job-items mb-30">
                                    <div class="job-items">
                                        ...
                                        <div class="job-tittle job-tittle2">
                                            ...
                                            <ul>
                                                <li>Creative Agency</li>
                                                <li><i class="fas fa-map-marker-alt"></i>Fes</li>
                                                <li>3500DH - 4000DH</li>
                                            </ul>
                                        </div>
                                    </div>
